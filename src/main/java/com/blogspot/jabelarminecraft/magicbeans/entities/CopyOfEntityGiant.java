 ...
 *
 */
public class CopyOfEntityGiant extends EntityMob implements IEntityMagicBeans
{
	 ...
	 * @param parWorld
	 */
	public CopyOfEntityGiant(World parWorld) 
	{
		super(parWorld);
		
		// DEBUG
		System.out.println("EntityGiant() constructor");
